...
const AdminRestaurant = () => {
  ...
  useEffect(() => {
    fetch(
      `https://travel-xone-server-five.vercel.app/api/v1/bookings/All`
    )
      .then((res) => res.json())
      .then((data) => {
        setBookingData(data);
        ...
        <>
          ...
          <div className="block lg:flex justify-between text-black">
            ...
            <div className="w-[100%] lg:w-[80%] bg-slate-300 py-10 px-5 lg:px-10">
              {/* -------------body content Start------------------ */}
              <h3 class="text-xl xl:text-2xl dark:text-black font-semibold leading-7 xl:leading-9 w-full md:text-left text-blue-700">
              Restaurant Bookings
              </h3>
