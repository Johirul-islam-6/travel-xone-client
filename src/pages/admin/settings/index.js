                    ...
                    <form>
                      ...
                      <div class="mt-10 px-7">
                        ...
                        <div class="grid w-full grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-7 mt-7">
                          <div>
                            ...
                            <input
                              type="text"
                              class="w-full p-3 mt-4 border border-gray-300 rounded outline-none focus:bg-gray-50  placeholder:text-grey-400 dark:text-black text-sm"
                          ...
                          <div>
                            ...
                            {/* -----------------Select for Role---------------- */}
                            <div class="relative mb-3 max-w-xs dark:text-black">
                              <select class="w-full p-3 mt-4 border  border-gray-300 rounded outline-none focus:bg-gray-50 placeholder:text-grey-400 dark:text-black text-sm">
                                <option
                                  disabled
                                  selected
                                  value="1"
                      ...
                      <div class="pt-6 border-gray-300 mt-2 px-7">
                        ...
                        <div class="mt-10 border border-gray-300 rounded">
                          ...
                          <textarea
                            class="resize-none w-full h-[170px] px-4 py-4 text-base outline-none text-slate-600 dark:text-white"
                      ...
                      <div class="px-7 pt-7">
                        ...
                        <div class="container mx-auto w-11/12 xl:w-full">
                          <div class="w-full py-4 sm:px-0 bg-white dark:bg-gray-800 flex justify-center">
                            <button
                              role="button"
                              aria-label="cancel form"
                              class="bg-gray-200 focus:outline-none transition duration-150 ease-in-out hover:bg-gray-300 dark:bg-gray-700 rounded text-indigo-600 dark:text-indigo-500 px-6 py-2 text-xs mr-4 focus:ring-2 focus:ring-offset-2 focus:ring-gray-700"
                            >
                              Cancel
                            </button>
                            <button
...
AdminSettings.getLayout = function PageLayout(page) {
  return <>{page}</>;
};
