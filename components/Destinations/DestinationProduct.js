...
const DestinationProduct = (props) => {
  ...
  return (
    <>
      <section className=" container py-10 mx-auto md:px-10">
        <div>
          <div>
                        ...
                        hotelAll?.map(hotel => {
                          return (
                            <article
                              ...
                              key={hotel?._id} class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
                              <a href="">
                                <div
                                  data-aos="zoom-in"
