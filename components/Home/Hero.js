            ...
            <div className="flex justify-center items-center">
              <div className="grid grid-cols-3 top_div w-[60%] md:w-[30%] px-2 text-[#000000c9] font-semibold rounded-t-full bg-[#ffffffe5] absolute mx-auto z-10 top-[27%] md:top-[45.5%] ">
                <div className="top_text grid justify-center items-center py-6 border-b-4 hover:border-amber-600 cursor-pointer">
                  <h1
                    onClick={(event) => HomeServecesClick("Toure")}
                ...
                <div className="top_text grid justify-center items-center py-6 hover:border-b-4  hover:border-amber-600 cursor-pointer">
                  <h1
                    onClick={(event) => HomeServecesClick("Flight")}
                    className="font-sans text-[16px] font-bold"
                  >
                    Flight
                  </h1>
                ...
                <div className="top_text grid justify-center items-center py-6 hover:border-b-4  hover:border-amber-600 cursor-pointer">
                  <h1
                    onClick={(event) => HomeServecesClick("Hotel")}
                    className="font-sans text-[16px] font-bold"
                  >
                    Hotel
                  </h1>
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                              ...
                              <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                                <h3 className="text-3xl font-semibold text-black">
                                  Travel
                                  <span className="text-blue-600">.Xone</span>
                                </h3>
                                <button
                              ...
                              <div className="relative p-6 flex-auto">
                                <p className="my-4 text-slate-500 text-lg leading-relaxed">
                                  ...
                                  inspires us to see, try new things.
                                </p>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                  <div className="form-control w-full max-w-xs">
                                    ...
                                    <input
                                      ...
                                      className="input input-bordered w-full max-w-xs bg-blue-400 text-white"
                                    />
                                  </div>
                                  <div className="form-control w-full max-w-xs">
                                    <label className="label">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                  <div className="form-control w-full max-w-xs">
                                    ...
                                    <input
                                      name="fLocation"
                                      type="text"
                                      defaultValue={bookingData?.FromLocation}
                                      className="input input-bordered w-full max-w-xs bg-blue-400 text-white"
                                    />
                                  </div>
                                  <div className="form-control w-full max-w-xs">
                                    ...
                                    <input
                                      name="tLocation"
                                      type="text"
                                      defaultValue={bookingData?.ToLocation}
                                      className="input input-bordered w-full max-w-xs bg-blue-400 text-white"
                                    />
                                  </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                  <div className="form-control w-full max-w-xs">
                                    ...
                                    <input
                                      name="jdate"
                                      type="text"
                                      defaultValue={bookingData?.JarnyDate}
                                      className="input input-bordered w-full max-w-xs bg-blue-400 text-white"
                                    />
                                  </div>
                                  <div className="form-control w-full max-w-xs">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                  ...
                                  <div className="form-control w-full max-w-xs">
                                    ...
                                    <input
                                      name="member"
                                      type="text"
                                      defaultValue={bookingData?.Member}
                                      className="input input-bordered w-full max-w-xs bg-blue-400 text-white"
                                    />
                                  </div>
                                </div>
                                <div className="grid grid-cols-2 gap-2">
                                  <div className="form-control w-full max-w-xs">
                                    ...
                                    <input
                                      name="FJD"
                                      type="text"
                                      defaultValue={bookingData?.FlightDate}
                                      className="input input-bordered w-full max-w-xs bg-blue-400 text-white"
                                    />
                                  </div>
                                  <div className="form-control w-full max-w-xs">
                                    ...
                                    <input
                                      name="Flight"
                                      type="text"
                                      defaultValue={bookingData?.Flight}
                                      className="input input-bordered w-full max-w-xs bg-blue-400 text-white"
                                    />
                                  </div>
                                </div>
                                <div className="grid grid-cols-2 gap-2">
                                  <div className="form-control w-full max-w-xs">
                                    ...
                                    <input
                                      name="HotelP"
                                      type="text"
                                      defaultValue={bookingData?.HotelPlaces}
                                      className="input input-bordered w-full max-w-xs bg-blue-400 text-white"
                                    />
                                  </div>
                                  <div className="form-control w-full max-w-xs">
                                    ...
                                    <input
                                      name="HotelN"
                                      type="text"
                                      defaultValue={bookingData?.HotelName}
                                      className="input input-bordered w-full max-w-xs bg-blue-400 text-white"
                                    />
                                  </div>
                                </div>
                  ...
                  <div className="block bg-[#00000041] md:w-[70%] py-7 mx-auto mt-3 rounded-xl absolute md:top-[53%] top-[35%] px-5 pb-8">
                    ...
                    <div className="card grid grid-cols-2 justify-center items-center md:grid-cols-5 gap-2 ">
                      <div className="border-2 border-[#c7c6c6] py-3 px-5 rounded-lg">
                        <p className="text-[16px] text-[#dcdada] text-start pl-2 pb-1 font-mono font-bold">
                          FROM
                        </p>
                        ...
                        <input
                          ...
                          placeholder="Dhaka"
                          type="text"
                          className="w-[100%] mx-auto py-2 rounded-md pl-5  bg-[#3a3939] "
                          required
                        />
                      </div>
                      ...
                      <div
                        select
                        className="border-2 border-[#c7c6c6] py-3 px-5 rounded-lg bg-"
                      >
                        <p className="text-[16px] text-[#dcdada] text-start pl-2 pb-1 font-mono font-bold">
                          TO
                        </p>
                        <select
                          onChange={(e) => handelTO(e)}
                          className="focus:outline-none text-md font-normal w-[100%] px-5 py-2 rounded-md mx-auto bg-[#3a3939] "
                        >
                      ...
                      <div
                        select
                        className="border-2 border-[#c7c6c6] py-3 px-5 rounded-lg"
                      >
                        <p className="text-[16px] text-[#dcdada] text-start pl-2 pb-1 font-mono font-bold">
                          JOURNEY DATE
                        </p>
                      ...
                      >
                        ...
                        <select
                          onChange={(e) => handelMember(e)}
                          className="focus:outline-none bg-[#3a3939]  text-md font-normal w-[100%] px-5 py-2 rounded-md mx-auto"
                          required
                        >
                          <option disabled selected>
                            Members
                      ...
                      <div
                        select
                        className="border-2 border-[#c7c6c6] py-3 px-5 rounded-lg md:hidden"
                      >
                        <p className="text-[16px] text-[#dcdada] text-start pl-2 pb-1 font-mono font-bold">
                          GENDER
                        </p>
                    ...
                    <div className="flex justify-center mt-5 md:hidden">
                      <button
                        onClick={SubmitTourestData}
                        className="btn btn-primary px-14 bg-[#ffffff] text-black"
                      >
                        submit
                      </button>
                      ...
                      {showModal ? (
                        <>
                          <div className="justify-center items-center flex md:hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
              ...
              {singelServeics === "Flight" && (
                <>
                  <div className="block bg-[#00000041] md:w-[70%] py-7 mx-auto mt-3 rounded-xl absolute md:top-[53%] top-[35%] px-5 pb-8">
                    ...
                    <div className="flex justify-center mt-5 md:hidden">
                      <button className="btn btn-primary px-14 bg-[#ffffff] text-black">
                        submit
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="block bg-[#00000041] md:w-[70%] py-7 mx-auto mt-3 rounded-xl absolute md:top-[53%] top-[35%] px-5 pb-8">
                    ...
                    <div className="card grid grid-cols-2 justify-center items-center md:grid-cols-2 gap-2 ">
                      ...
                      >
                        ...
                        <select
                          onChange={(e) => handelHotelLocation(e)}
                          className="focus:outline-none text-md bg-[#3a3939]  font-normal w-[100%] px-5 py-2 rounded-md mx-auto"
                        >
                          <option disabled selected>
                            Select Locations
                          </option>
                          {hotels?.data?.map((hotel) => (
                            <option>{hotel?.placeName}</option>
                          ))}
                        </select>
                      </div>
                      {/* ------------hotels name */}
